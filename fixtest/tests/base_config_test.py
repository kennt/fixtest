...
class TestConfig(unittest.TestCase):
    ...
    def test_get_role(self):
        ...
        self.assertEqual(19001, role_config['admin-port'])
    ...
    def test_get_link(self):
        ...
        self.assertEqual('client-fix-server', link_config['name'])
    ...
    def test_get_section(self):
        ...
        self.assertEqual('hello', other_config['test-id'])
...
class TestFileConfig(unittest.TestCase):
    ...
    def test_fileconfig(self):
        ...
        self.assertIsNotNone(role_config)
        self.assertEqual(19404, role_config['admin-port'])

        link_config = config.get_link('client', 'gateway', 'FIX')
        self.assertIsNotNone(link_config)
        self.assertEqual('client-FIX-gateway', link_config['name'])
